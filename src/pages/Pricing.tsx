    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-[#1A1F2C] to-[#221F26] text-white">
      <div className="px-4 py-[100px] animate-fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8 mb-16 max-w-6xl mx-auto">
          {/* Lite Plan */}
          <div className="bg-gray-800/60 backdrop-blur-sm border border-gray-700/30 rounded-xl p-6 flex flex-col h-full overflow-hidden transition-all duration-300 hover:shadow-lg">
          ...
          {/* Pro Plan */}
          <div className="relative bg-gray-800/60 backdrop-blur-sm border border-violet-500/30 rounded-xl p-6 flex flex-col h-full overflow-hidden transition-all duration-300 hover:shadow-lg">
          ...
          <div className="bg-gray-800/60 backdrop-blur-sm border border-gray-700/30 rounded-xl p-6 flex flex-col h-full overflow-hidden transition-all duration-300 hover:shadow-lg">
            <div className="flex-grow">
              ...
              <div className="mb-6">
                ...
                <span className="text-gray-300 text-sm ml-1"> per pack</span>
              </div>
              <ul className="space-y-3 mb-6">
                <li className="flex items-start">
                  <Check className="w-5 h-5 text-green-400 mr-2 flex-shrink-0" />
        ...
        {/* FAQ Section */}
        <div className="max-w-3xl mx-auto px-4 bg-gray-800/40 backdrop-blur-sm rounded-xl p-6 border border-gray-700/30">
          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-4" className="border-b border-gray-700/50">
              <AccordionTrigger className="text-left text-white py-4">How is billing handled?</AccordionTrigger>
              <AccordionContent className="text-gray-300 pb-4">
        ...
        <div className="text-center mt-16">
          ...
          <Button className="bg-violet-600 hover:bg-violet-700 text-white px-8 py-6 rounded-lg text-lg" onClick={freeTrial}>
